...
/**
 * dismount - do zrzucania z konia - powinno byæ wywo³ywane wszêdzie tam,
 * gdzie postaæ spada/zsiada z konia
 */
void do_dismount_body(CHAR_DATA *ch);

/**
 * Przej¶cie innych graczy za koniem na którym jad±
 * koñ jest prowadzony przez ch
 * przej¶cie nastêpuje z pokoju in_room do pokoju to_room
 */
