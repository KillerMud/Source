 ...
 ***********************************************************************
 *
 * $Id: tables.c 113 2013-07-22 09:46:30Z drake $
 * $HeadURL: svn+ssh://svn@killer.mud.pl/killer/branches/current/src/tables.c $
 *
 */
...
const struct ext_flag_type act_flags[] =
{
	...
	{	"exp_num",			&PLR_EXP_NUM,		FALSE	},
	{	"exp_rpg",		    &PLR_EXP_RPG,		FALSE	},
	{	NULL,				0,					0		}
};
...
const struct flag_type weapon_type2[] =
{
   ...
   { "heartseeker", WEAPON_HEARTSEEKER, TRUE },
	{   "flaming burst",		WEAPON_FLAMING_BURST,		TRUE    },
	{   "frost burst",		WEAPON_FROST_BURST,		TRUE    },
	{	"shocking burst",		WEAPON_SHOCKING_BURST,	TRUE    },
	{	"toxic burst",		WEAPON_TOXIC_BURST,		TRUE	},
	{	"holy",		WEAPON_HOLY,		TRUE	},
	{	"sonic burst",		WEAPON_SONIC_BURST,	TRUE	},
