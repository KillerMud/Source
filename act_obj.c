 ...
 ***********************************************************************
 *
 * $Id: act_obj.c 155 2013-08-08 20:50:23Z drake $
 * $HeadURL: svn+ssh://svn@killer.mud.pl/killer/branches/current/src/act_obj.c $
 *
 */
...
void do_envenom( CHAR_DATA *ch, char *argument )
{
    ...
    if ( weapon->item_type == ITEM_WEAPON )
    {
        ...
        if ( IS_WEAPON_STAT( weapon, WEAPON_FLAMING )
                ...
                || IS_WEAPON_STAT( weapon, WEAPON_FROST_BURST )
                || IS_WEAPON_STAT( weapon, WEAPON_UNHOLY )
                || IS_WEAPON_STAT( weapon, WEAPON_TOXIC_BURST )
                || IS_WEAPON_STAT( weapon, WEAPON_HOLY )
                || IS_WEAPON_STAT( weapon, WEAPON_SONIC_BURST )
                || IS_WEAPON_STAT( weapon, WEAPON_SHOCKING_BURST )  
                || IS_WEAPON_STAT( weapon, WEAPON_NEGATIVE ) )
        {
...
void wear_obj( CHAR_DATA *ch, OBJ_DATA *obj, bool fReplace )
{
	...
	/* Drake: dodanie mo¿liwo¶ci zak³adania turn_itemów w walce */
    if ( ch->fighting && ( !CAN_WEAR( obj, ITEM_WEAR_SHIELD ) || !CAN_WEAR( obj, ITEM_TURN ) ) )
    {
