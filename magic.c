 ...
 ***********************************************************************
 *
 * $Id: magic.c 126 2013-07-27 11:52:44Z drake $
 * $HeadURL: svn+ssh://svn@killer.mud.pl/killer/branches/current/src/magic.c $
 *
 */
...
void do_cast( CHAR_DATA *ch, char *argument )
{
    ...
    int bonus_from_feat, bonus_from_sector = 0, bonus_from_wand = 0;
	//int wis_or_int = 0;
    //int pskill = 0;
    //float sskill = 100;
   ...
   //Szaman potrafi szybciej rzucac czary.
	...
	//Drake: Na pro¶bê kleryka zakomentowa³em.
