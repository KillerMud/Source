 ...
 ***********************************************************************
 *
 * $Id: bit.c 110 2013-07-18 08:34:31Z gurthg $
 * $HeadURL: svn+ssh://svn@killer.mud.pl/killer/branches/current/src/bit.c $
 *
 */
...
BITVECT_DATA AFF_AID							= {4, D};
BITVECT_DATA AFF_DEATHWARD						= {4, G};
...
BITVECT_DATA PLR_EXP_NUM						= {2,    C};
BITVECT_DATA PLR_EXP_RPG						= {2,    D};
...
BITVECT_DATA ITEM_NO_HOARD         = { 0, cc };
