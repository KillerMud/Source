 ...
 ***********************************************************************
 *
 * $Id: magic.h 143 2013-08-05 05:54:15Z drake $
 * $HeadURL: svn+ssh://svn@killer.mud.pl/killer/branches/current/src/magic.h $
 *
 * Spell functions.
 * Defined in magic.c.
 *
...
DECLARE_SPELL_FUN(	spell_deathward					);
DECLARE_SPELL_FUN(	spell_mass_protection_evil		);
DECLARE_SPELL_FUN(	spell_mass_protection_good		);
DECLARE_SPELL_FUN(	spell_mass_resist_negative		);
DECLARE_SPELL_FUN(	spell_mass_aid					);
DECLARE_SPELL_FUN(  spell_mass_cure_light			); 
DECLARE_SPELL_FUN(  spell_mass_cure_moderate		); 
DECLARE_SPELL_FUN(  spell_mass_cure_serious			); 
DECLARE_SPELL_FUN(  spell_mass_cure_critical		); 
