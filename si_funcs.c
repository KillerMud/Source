 ...
 ***********************************************************************
 *
 * $Id: si_funcs.c 157 2013-08-08 20:57:23Z drake $
 * $HeadURL: svn+ssh://svn@killer.mud.pl/killer/branches/current/src/si_funcs.c $
 *
 */
#define SI_FUNCS_C
...
bool nasty_hold( CHAR_DATA *ch, struct char_desc *desc )
{
    ...
    if ( SPELL_MEMMED( ch, gsn_holdperson ) && !is_undead( target->ch ) )
    {
