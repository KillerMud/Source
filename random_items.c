        ...
        case 2:
            ...
            switch ( choose )
            {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    name = "gwiezdny ró¿owy kwarc klejnot";
