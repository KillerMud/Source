   ...
   */
	...
	if ( immune || dam == 0 )
	{
		...
		if ( wield )
		{
			if ( ch->fighting == victim && number_percent() < 5 && IS_WEAPON_STAT( wield, WEAPON_FLAMING_BURST ) )
			{
				...
				act( "Fala ognia wylatuje z $j i trafia w $N sprawiaj±c, ze staje przez chwilê w p³omieniach.", ch, wield, victim, TO_CHAR );
				act( "$N staje na krótk± chwilê w p³omieniach kiedy dostaje ognista fal± z $j $z.", ch, wield, victim, TO_NOTVICT );
			...
			if ( ch->fighting == victim && number_percent() < 5 && IS_WEAPON_STAT( wield, WEAPON_FROST_BURST ) )
			{
				dam = UMIN(wield->value[6], wield->value[5]) * number_range( 8, 15 ) + number_range(30, 45);
				dam = UMAX(dam, number_range(30, 45)); //Dla broni z ujemnymi v5 i v6
				act( "$p rozb³yskuje zimnem i mro¼Ÿny podmuch uderza w $c.", victim, wield, NULL, TO_ROOM );
				act( "MroŸny podmuch wiatru z $f mrozi ciê do koœci.", ch, wield, victim, TO_VICT );
			...
			if ( ch->fighting == victim && number_percent() < 5 && IS_WEAPON_STAT( wield, WEAPON_SHOCKING_BURST ) )
			{
				dam = UMIN(wield->value[6], wield->value[5]) * number_range( 8, 15 ) + number_range(30, 45);
				dam = UMAX(dam, number_range(30, 45)); //Dla broni z ujemnymi v5 i v6
				act( "W nag³bym rozb³ysku œ¶wiat³a $f pora¿a $c moc± piorunów.", victim, wield, NULL, TO_ROOM );
				act( "$p pora¿a ciê olbrzymi± moc± piorunów.", victim, wield, NULL, TO_CHAR );
			...
			if ( ch->fighting == victim && number_percent() < 5 && IS_WEAPON_STAT( wield, WEAPON_TOXIC_BURST ) )
			{
				...
				act( "Kwasowy pocisk z $f trafia ciê i pali!", victim, wield, NULL, TO_CHAR );
			...
			if ( ch->fighting == victim && number_percent() < 5 && IS_WEAPON_STAT( wield, WEAPON_SONIC_BURST ) )
			{
				dam = UMIN(wield->value[6], wield->value[5]) * number_range( 8, 15 ) + number_range(30, 45);
				dam = UMAX(dam, number_range(30, 45)); //Dla broni z ujemnymi v5 i v6
			    act( "W nag³ym rozb³ysku moc± $f pora¿a $c fal± dzwiêkow±.", victim, wield, NULL, TO_ROOM );
			    act( "Pulsuj±c moc± $f pora¿a ciê prawdziw± kakofoni± fal dzwiêkowych.", victim, wield, NULL, TO_CHAR );
			...
			if ( ch->fighting == victim && number_percent() < 5 && IS_WEAPON_STAT( wield, WEAPON_HOLY ) )
			{
				...
				act( "Roz³byskuj±c potê¿n± œ¶wiêt± moc± $f trafia w $c.", victim, wield, NULL, TO_ROOM );
				act( "Rozb³yskuj±c potê¿n± œ¶wiêt± moc± $f trafia ciê prosto w pier¶.", victim, wield, NULL, TO_CHAR );
			...
			if ( ch->fighting == victim && number_percent() < 5 && IS_WEAPON_STAT( wield, WEAPON_UNHOLY ) )
			{
				...
				act( "Potê¿na z³a moc wylatuje z $f i trafia w $c.", victim, wield, NULL, TO_ROOM );
				act( "Potê¿na z³a moc promienuj¹ca z $f otacza i próbuje ciê zniszczyæ.", victim, wield, NULL, TO_CHAR );
				dam = UMAX(dam, number_range(20, 35)); //Dla broni z ujemnymi v5 i v6				
			...
			else if ( ch->fighting == victim && IS_WEAPON_STAT( wield, WEAPON_NEGATIVE ) || IS_WEAPON_STAT( wield, WEAPON_UNHOLY ) )
			{
				dam = number_range( base_dam / 4, base_dam / 2 );
				dam = UMAX( dam, 1 );
				act( "Ciemnoczerwona aura z $f otacza przez chwilê $c.", victim, wield, NULL, TO_ROOM );
				act( "Ciemnoczerwona aura z $f otacza i rani ciê.", victim, wield, NULL, TO_CHAR );
				damage( ch, victim, dam, 0, DAM_NEGATIVE, FALSE );
			}
	...
	if ( result && wield != NULL )
	{
		...
		if ( ch->fighting == victim && number_percent() < 5 && IS_WEAPON_STAT( wield, WEAPON_FLAMING_BURST ) )
		{
				dam = UMIN(wield->value[6], wield->value[5]) * number_range( 8, 15 ) + number_range(30, 45);
				dam = UMAX(dam, number_range(30, 45)); //Dla broni z ujemnymi v5 i v6
				act( "Fala ognia wylatuje z $j i trafia w $N sprawiajac, ze staje przez chwilê w p³omieniach.", ch, wield, victim, TO_CHAR );
				act( "$N staje na krotk± chwilê w p³omieniach kiedy dostaje ognista fal± z $j $z.", ch, wield, victim, TO_NOTVICT );
				act( "$p uderza w ciebie fal± p³omieni.", ch, wield, victim, TO_VICT );
				fire_effect( victim, 1, dam, TARGET_CHAR );
				damage( ch, victim, dam, 0, DAM_FIRE, FALSE );
		}
		...
		if ( ch->fighting == victim && number_percent() < 5 && IS_WEAPON_STAT( wield, WEAPON_FROST_BURST ) )
		{
				dam = UMIN(wield->value[6], wield->value[5]) * number_range( 8, 15 ) + number_range(30, 45);
				dam = UMAX(dam, number_range(30, 45)); //Dla broni z ujemnymi v5 i v6
				act( "$p rozb³yskuje zimnem i mroŸ¼ny podmuch uderza w $c.", victim, wield, NULL, TO_ROOM );
				act( "MroŸny podmuch wiatru z $f mrozi ciê do koœci.", ch, wield, victim, TO_VICT );
				cold_effect( victim, 1, dam, TARGET_CHAR );
				damage( ch, victim, dam, 0, DAM_COLD, FALSE );
		}
		...
		if ( ch->fighting == victim && number_percent() < 5 && IS_WEAPON_STAT( wield, WEAPON_SHOCKING_BURST ) )
		{
				dam = UMIN(wield->value[6], wield->value[5]) * number_range( 8, 15 ) + number_range(30, 45);
				dam = UMAX(dam, number_range(30, 45)); //Dla broni z ujemnymi v5 i v6
				act( "W nag³bym rozb³ysku œwiat³a $f pora¿a $c moc¹ piorunów.", victim, wield, NULL, TO_ROOM );
				act( "$p pora¿a ciê olbrzymi¹ moc¹ piorunów.", victim, wield, NULL, TO_CHAR );
				shock_effect( victim, 1, dam, TARGET_CHAR );
				damage( ch, victim, dam, 0, DAM_LIGHTNING, FALSE );
		}
		...
		if ( ch->fighting == victim && number_percent() < 5 && IS_WEAPON_STAT( wield, WEAPON_SONIC_BURST ) )
		{
				dam = UMIN(wield->value[6], wield->value[5]) * number_range( 8, 15 ) + number_range(30, 45);
				dam = UMAX(dam, number_range(30, 45)); //Dla broni z ujemnymi v5 i v6
			    act( "W nag³ym rozb³ysku moc $f pora¿a $c fal± dzwiêków.", victim, wield, NULL, TO_ROOM );
			    act( "Pulsuj±ca moc $f pora¿a ciê prawdziw± kakofoni± fal dzwiêkowych.", victim, wield, NULL, TO_CHAR );
				sound_effect( victim, 1, dam, TARGET_CHAR );
				damage( ch, victim, dam, 0, DAM_SOUND, FALSE );
		}
		else if ( ch->fighting == victim && IS_WEAPON_STAT( wield, WEAPON_RESONANT ) || IS_WEAPON_STAT( wield, WEAPON_SONIC_BURST ) )
		...
		{
				dam = UMIN(wield->value[6], wield->value[5]) * number_range( 4, 12 ) + number_range(40, 60);
				act( "Rozb³yskuj±c potê¿na ¶wiêta moc $f trafia w $c.", victim, wield, NULL, TO_ROOM );
				act( "Rozb³yskuj±c potê¿n± ¶œwiêt± moc± $f trafia ciê prosto w pier¶.", victim, wield, NULL, TO_CHAR );
				dam = UMAX(dam, number_range(20, 35)); //Dla broni z ujemnymi v5 i v6
				damage( ch, victim, dam, 0, DAM_HOLY, FALSE );
				if( IS_NPC(victim) && victim->pIndexData->vnum == MOB_VNUM_AVATAR )
				{
...
bool spell_damage( CHAR_DATA *ch, CHAR_DATA *victim, int dam, int sn, int dam_type, bool show )
{
	...
	// ~15% wiêcej obra¿eñ ze spelli w mobki.
	...
	if ( IS_SET( ch->attack_flags, WEAPON_SACRED ) )
	{
		...
		if( IS_NPC(victim) && victim->pIndexData->vnum == MOB_VNUM_AVATAR )
		{
			...
			if ( IS_SET( ch->attack_flags, WEAPON_SACRED ) )
			{
				dam = number_range( base_dam / 4, base_dam / 2 );
				dam = UMAX( dam, 1 );
				act( "Dotyk $Z pora¿a $c mroczn¹, przeklêt¹ energi¹.", victim, NULL, NULL, TO_ROOM );
				act( "Dotyk $Z pora¿a ciê mroczn¹, przeklêt¹ energi¹", victim, NULL, NULL, TO_CHAR );
				damage( ch, victim, dam, 0, DAM_NEGATIVE, FALSE );
			}
		...
		if (!( IS_NPC( ch ) && ch->pIndexData->vnum == 3 ))
		{
			...
			switch( number_range( 1, 4 ) )
			{
				case 1:
					...
					print_char( ch, "{4Od³amki skalne z tarczy ¿ywio³ów %s {4dotkliwie ciê rani±!{x\n\r", PERS4( victim, ch ) );
					print_char( victim, "{2Od³amki skalne z otaczaj±cej ciê tarczy ¿ywio³ów dotkliwie rani± %s{2!{x\n\r", PERS4( ch, victim ) );
					act( "{3Od³amki skalne z tarczy ¿ywio³ów $z {3dotkliwie rani± $C{3!{x", victim, NULL, ch, TO_NOTVICT );
					...
					break;
				case 2:
					print_char( ch, "{4P³omienie z tarczy ¿ywio³ów %s {4pal± ciê!{x\n\r", PERS4( victim, ch ) );
					print_char( victim, "{2P³omienie z otaczaj¹cej ciê tarczy ¿ywio³ów pal± %s{x\n\r", PERS4( ch, victim ) );
					act( "{3P³omienie z tarczy ¿ywio³ów $z {3pal± $C{3!{x", victim, NULL, ch, TO_NOTVICT );
					damage( victim, ch, dice( 3, 8 ) + (level-10) / 5, gsn_shield_of_nature, DAM_FIRE, FALSE );
					break;
				case 3:
					
					print_char( ch, "{4Ch³ód z tarczy ¿ywio³ów %s {4mrozi ciê!{x\n\r", PERS4( victim, ch ) );
					print_char( victim, "{2Ch³ód z otaczaj±cej ciê tarczy ¿ywio³ów mrozi %s{2!{x\n\r", PERS4( ch, victim ) );
					act( "{3Ch³ód z tarczy ¿ywio³ów $z {3mrozi $C{3!{x", victim, NULL, ch, TO_NOTVICT );
					...
					if ( chance == 1 || chance == 2 ) //czyli na 2% szansy
					{
						...
						send_to_char( "Œwiat wokó³ ciebie znacznie przyœpiesza...\n\r", ch );
						act( "$n zaczyna poruszaæ siê znacznie wolniej.", ch, NULL, NULL, TO_ROOM );
					}
					break;
				case 4:
					print_char( ch, "{4Wy³adowania z tarczy ¿ywio³ów %s {4pora¿aj± twe miêœnie!{x\n\r", PERS4( victim, ch ) );
					print_char( victim, "{2Wy³adowania z otaczaj±cej ciê tarczy ¿ywio³ów pora¿aj± %s{2!{x\n\r", PERS4( ch, victim ) );
					act( "{3Wy³adowania z tarczy ¿ywio³ów $z {3pora¿aj± $C{3!{x", victim, NULL, ch, TO_NOTVICT );
					damage( victim, ch, dice( 2, 8 ) + (level-10) / 5, gsn_shield_of_nature, DAM_LIGHTNING, FALSE );
					chance = number_range( 1, 100 );
					if ( chance == 1 || chance == 2 ) //czyli na 2% szansy
					{
						act( "{5Pod wp³ywem wy³adowañ elektrycznych $z opada na ziemiê.{x", ch, NULL, NULL, TO_ROOM );
						send_to_char( "{5Pod wp³ywem wy³adowañ elektrycznych opadasz na ziemiê.{x\n\r", ch );
						ch->position = POS_SITTING;
						WAIT_STATE( ch, 3 * PULSE_VIOLENCE );
					}
					break;
				default:
					print_char( ch, "{4Wy³adowania z tarczy ¿ywio³ów %s {4pora¿aj± twe miê¶nie!{x\n\r", PERS4( victim, ch ) );
					print_char( victim, "{2Wy³adowania z otaczaj±cej ciê tarczy ¿ywio³ów pora¿aj± %s{2!{x\n\r", PERS4( ch, victim ) );
					act( "{3Wy³adowania z tarczy ¿ywio³ów $z {3pora¿aj± $C{3!{x", victim, NULL, ch, TO_NOTVICT );
					damage( victim, ch, dice( 2, 8 ) + (level-10) / 5, gsn_shield_of_nature, DAM_LIGHTNING, FALSE );
					chance = number_range( 1, 100 );
