 ...
 ***********************************************************************
 *
 * $Id: merc.h 113 2013-07-22 09:46:30Z drake $
 * $HeadURL: svn+ssh://svn@killer.mud.pl/killer/branches/current/src/merc.h $
 *
 */
#define NOCRYPT
...
extern BITVECT_DATA AFF_AID;
extern BITVECT_DATA AFF_DEATHWARD;
...
extern BITVECT_DATA PLR_EXP_NUM;
extern BITVECT_DATA PLR_EXP_RPG;
...
extern BITVECT_DATA ITEM_NO_HOARD;
...
#define OBJ_VNUM_SPIRITUAL_SWORD		10914
...
#define WEAPON_NEGATIVE			(J) // broñ zadaje dodatkowe obra¿enia od negatywnej energi, lecz¹c undeadów (sic!)
#define WEAPON_HOLY					(P) // sacred burst - szansa na dodatkowy mocny rozb³ysk œwiêtej energii
#define WEAPON_UNHOLY				(W) // negative burst - szansa na dodadtkowy mocny rozb³ysk negatywnej energi
#define WEAPON_FLAMING_BURST (X) // bron zadaje obrazenia od ognia i ma szansê poraziæ wroga dodatkowymi obra¿eniami
#define WEAPON_FROST_BURST   (Y) // j/w tylko lód
#define WEAPON_SHOCKING_BURST (Z) // j/w tylko piorun
#define WEAPON_TOXIC_BURST (aa) // j/w tylko kwas
#define WEAPON_SONIC_BURST (bb) // j/w tylko sound
#define WEAPON_RANDOM_MAGIC_PLUS (cc) // randomowo dodaje broni ummagicznienie na poziomie 0-3
...
struct char_data
{
	...
	sh_int					statpointsspent_str; //iloœæ addstatów na kolejne staty (po 31)
	sh_int					statpointsspent_int;
	sh_int					statpointsspent_wis;
	sh_int					statpointsspent_dex;
	sh_int					statpointsspent_con;
	sh_int					statpointsspent_cha;
	sh_int					statpointsspent_luc;
	/* parts stuff */
	long					form;
	long					parts;
	sh_int					size;
...
extern const char * stat_info_list       []; 
